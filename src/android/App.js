                    ...
                    <Scene
                        ...
                        <Scene key="main" tabs={true} tabBarStyle={styles.tabBarStyle} tabBarSelectedItemStyle={styles.tabBarSelectedItemStyle}>
                            <Scene key="homeBlock" icon={TabIcon} initial={true} online='ios-home' outline='ios-home-outline' >
                                ...
                                <Scene key="command"  isRequirePopRefresh={true} rightType={1} title='调度指令' component={Command} hideTabBar hideNavBar={false} navBar={NavBar} />
                            ...
                            <Scene key="workBlock" icon={TabIcon} online='ios-bus' outline='ios-bus-outline' >
                                ...
                                <Scene key="receiveAtWorkBlock" title='选择经销商' component={Receive} hideNavBar={false} hideTabBar={true} navBar={NavBar} />
                                <Scene key="truckAtWorkBlock" title='选择货车' component={Truck} hideNavBar={false}  hideTabBar={true}navBar={NavBar} />
                                <Scene key="driverAtWorkBlock" title='选择司机' component={Driver} hideNavBar={false} hideTabBar={true} navBar={NavBar} />
                                <Scene key="carVinAtWorkBlock" title='选择商品车' component={CarVin} hideNavBar={false} hideTabBar={true} navBar={NavBar} />
                                <Scene key="baseAddrAtWorkBlock" title='选择装车地点' component={BaseAddr} hideNavBar={false} hideTabBar={true} navBar={NavBar} />
                                <Scene key="commandListAtWorkBlock" title='指令列表' component={CommandList} hideNavBar={false}  hideTabBar={true}  navBar={NavBar} />
                            ...
                            <Scene key="settingBlock" icon={TabIcon} online='ios-settings' outline='ios-settings-outline' >
                                ...
                                <Scene key="cityAtSettingBlock" title='选择城市' hideTabBar={true}  component={City} hideNavBar={false} navBar={NavBar} />
                                <Scene key="baseAddrAtSettingBlock" title='选择装车地点' hideTabBar={true}  component={BaseAddr} hideNavBar={false} navBar={NavBar} />
                                <Scene key="password" title='修改密码' hideTabBar={true}  component={Password} hideNavBar={false} navBar={NavBar} />
                            </Scene>
                        </Scene>
                    </Scene>
                </Scene>
